...
export const clinicInfo: ClinicInfo = {
  ...
  tagline: "Заботьтесь о своих стопах — аппаратный педикюр и профессиональная подология в Иркутске от 2 000 ₽",
  city: "г. Иркутск",
  ...
  dikidiUrl: "https://dikidi.net/953518",
  ...
  doctorExperience: "Более 8 лет опыта",
...
export const trustStats: TrustStat[] = [
  {
    ...
    description: "112 оценок и 107 реальных отзывов от благодарных пациентов",
  },
  {
    id: "exp",
    value: 8,
...
export const marqueeItems: string[] = [
  ...
  "Запись онлайн через DIKIDI и мессенджеры",
];
...
export const whyChooseUs: WhyChooseUsItem[] = [
  ...
  },
  {
    ...
    description: "4-этапная обработка инструментов: дезинфекция, ультразвуковая очистка, сушка и автоклавирование в крафт-пакете, который вскрывается при вас.",
  },
  {
    number: "03",
    title: "Профильное образование и опыт",
    description: "Татьяна Оксанычева более 8 лет регулярно повышает квалификацию по аппаратному педикюру, ортониксии и микологии.",
  },
  {
    number: "04",
